...
if (isset($_GET['delete-id'])) {
    ...
    $query = mysqli_query($mysqli, "DELETE FROM `bansystem_bans-country` WHERE id='$id'");
}
...
<div class="content-wrapper">
			...
			<div id="content-container">
				...
				<section class="content-header">
    			  <h1><i class="fa fa-globe"></i> Country Bans</h1>
    			  <ol class="breadcrumb">
   			         <li><a href="dashboard.php"><i class="fa fa-home"></i> Admin Panel</a></li>
    			     <li class="active">Country Bans</li>
    			  </ol>
    			</section>
...
if (isset($_POST['add-country'])) {
    ...
    if ($redirect == 'Yes' && $url == NULL) {
        echo '<br />
			<div class="callout callout-danger">
                <p><i class="fa fa-exclamation-triangle"></i> Please enter a link to which will be redirected all visitors from the banned country.</p>
			</div>';
    } else {
        $queryvalid = mysqli_query($mysqli, "SELECT * FROM `bansystem_bans-country` WHERE country='$country' LIMIT 1");
        $validator  = mysqli_num_rows($queryvalid);
        if ($validator > "0") {
            echo '<br />
			<div class="callout callout-info">
                <p><i class="fa fa-info-circle"></i> This <strong>Country</strong> is already added.</p>
			</div>';
        } else {
            $query = mysqli_query($mysqli, "INSERT INTO `bansystem_bans-country` (country, redirect, url) VALUES('$country', '$redirect', '$url')");
        }
    }
}
?>
...
if (isset($_GET['edit-id'])) {
    ...
    $result = mysqli_query($mysqli, "SELECT * FROM `bansystem_bans-country` WHERE id = '$id'");
	...
	if (isset($_POST['edit-ban'])) {
        ...
        if ($redirect == 'Yes' and $url == NULL) {
            ...
            $update = mysqli_query($mysqli, "UPDATE `bansystem_bans-country` SET country='$country', redirect='$redirect', url='$url' WHERE id='$id'");
        }
    }
?>
 <form class="form-horizontal" action="" method="post">
                    <div class="box">
						<div class="box-header">
							<h3 class="box-title">Edit - Country Ban</h3>
						</div>
						<div class="box-body">
...
?>
				    ...
				    <div class="box">
						<div class="box-header">
							<h3 class="box-title">Country Bans</h3>
						</div>
						<div class="box-body">
...
<table id="dt-basic" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									<thead>
										<tr>
                                            ...
                                            <th><i class="fa fa-share"></i> Redirecting</th>
											<th>Actions</th>
										</tr>
									</thead>
									<tbody>
<?php
$query = mysqli_query($mysqli, "SELECT * FROM `bansystem_bans-country`");
while ($row = mysqli_fetch_assoc($query)) {
    echo '
										<tr>
                                            ...
                                            <a href="?delete-id=' . $row['id'] . '" class="btn btn-flat btn-success"><i class="fa fa-trash"></i> Delete</a>
											</td>
										</tr>
';
}
