...
$settings['bansystem_path']       = substr($fullpath, 0, strpos($fullpath, '/install'));
...
<div class="alert alert-success">
	Ban System has been successfully installed on your website!
</div>
...
<b>Put the integration code in the top (or bottom) part of one main <i>.php</i> file of your website to integrate it with Ban System.</b><br />
...
<br /><br />
	<kbd>include "bansystem/ban-system.php";</kbd>
</div>
    
<a href="../" class="btn-success btn btn-block"><i class="fas fa-arrow-circle-right"></i> Continue to Ban System</a>
</center>
<?php
footer();
?>