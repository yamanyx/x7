...
?>
			<center><h6>Enter your database connection details. If you’re not sure about these, contact your host.</h6></center><hr />
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">
					    <div class="input-group">
							...
							<input type="text" name="database_name" class="form-control" placeholder="bans" value="<?php
...
?>
				<input class="btn-primary btn col-12 mt-2 mb-3" type="submit" name="submit" value="Next" />
			</form>
		</div>
<?php
footer();
